...
os.chdir(r'C:\Users\Yashraj\OneDrive - Indian Institute of Technology Patna\Desktop\VS Code\Python\Announcement_to_scorecard_project') # making the parent directory as current directory
import csv
